...
function WagerLayout({ id, refreshAccountRequest, props }) {
    ...
    const beliefA = belief_a / 100;
    const beliefB = belief_b / 100;
        ...
        <Box sx={{my:'2rem'}}>
            ...
            <Box sx={{my:'2rem'}}>
                ...
                <div className="flex align-vertical" style={{gap:'2rem'}}>
                    ...
                    <h5>{displayA}</h5>
                    <SubmitDeposit id={id} stake={contract.stake} paid={paid_a} refreshAccountRequest={refreshAccountRequest} />
                    { paid_a &&
                        <UpdateBelief id={id} active={activeButtonA} refreshAccountRequest={refreshAccountRequest} /> 
                    }
                    {/*<SetApproval/>*/}
                    {/*<LockSubmission/>*/}
                </div>
                ...
                <div className="flex align-vertical" style={{gap:'2rem'}}>
                    ...
                    <h5>{displayB}</h5>
                    <SubmitDeposit id={id} stake={contract.stake} paid={paid_b} refreshAccountRequest={refreshAccountRequest} />
                    { paid_b &&
                        <UpdateBelief id={id} active={activeButtonB} refreshAccountRequest={refreshAccountRequest} /> 
                    }
                    {/*<SetApproval/>*/}
                    {/*<LockSubmission/>*/}
                </div>
